...
def prompt_template_baseline() -> PromptTemplate:
    return PromptTemplate(
        template="Reverse the string {input_string} and replace 'o' and 'i' with 0 and 1 respectively. The output should be the reversed  string with the 'o' and 'i' replaced with '0' and '1' respectively. no further explanation or commentary is needed.",
        engine="f-string",
    )
